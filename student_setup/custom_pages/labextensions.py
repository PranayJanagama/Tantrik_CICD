...
class InstallLabExtensionApp(BaseExtensionApp):
    ...
    #by teleparadigm
    def run_task(self):
        self.log.error("Disabled to install extensions..")
...
class DevelopLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        ...
        self.log.error("Disabled to develop extensions..")
       # self.extra_args = self.extra_args or [os.getcwd()]
...
class BuildLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to build extensions..")
        #self.extra_args = self.extra_args or [os.getcwd()]
       # build_labextension(
        #    self.extra_args[0],
         #   logger=self.log,
...
class WatchLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to watch extensions..")
       # self.extra_args = self.extra_args or [os.getcwd()]
       # labextensions_path = self.labextensions_path
       # watch_labextension(
        #    self.extra_args[0],
...
class UpdateLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to update extensions..")
       # self.deprecation_warning(
...
class LinkLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to link extensions..")
       # self.extra_args = self.extra_args or [os.getcwd()]
       # options = AppOptions(
        #    app_dir=self.app_dir,
         #   logger=self.log,
...
class UnlinkLabExtensionApp(BaseExtensionApp):
    ...
    #by teleparadigm
    def run_task(self):
        self.log.error("Disabled to unlink extensions..")
        #self.extra_args = self.extra_args or [os.getcwd()]
       # options = AppOptions(
        #    app_dir=self.app_dir,
         #   logger=self.log,
...
class UninstallLabExtensionApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to uninstall extensions..")
...
class ListLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to list extensions..")
       # list_extensions(
        #    app_options=AppOptions(
         #       app_dir=self.app_dir,
          #      logger=self.log,
...
class EnableLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to enable extensions..")
        #app_options = AppOptions(
         #   app_dir=self.app_dir,
          #  logger=self.log,
          #  core_config=self.core_config,
...
class DisableLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to disable extensions..")
        #app_options = AppOptions(
         #   app_dir=self.app_dir,
          #  logger=self.log,
           # core_config=self.core_config,
...
class LockLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to lock extensions..")
        #app_options = AppOptions(
         #   app_dir=self.app_dir,
          #  logger=self.log,
          #  core_config=self.core_config,
...
class UnlockLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to unlock extensions..")
        #app_options = AppOptions(
         #   app_dir=self.app_dir,
          #  logger=self.log,
           # core_config=self.core_config,
...
class CheckLabExtensionsApp(BaseExtensionApp):
    ...
    def run_task(self):
        self.log.error("Disabled to check extensions..")
        #app_options = AppOptions(
         #   app_dir=self.app_dir,
          #  logger=self.log,
           # core_config=self.core_config,
