...
class ContentsHandler(ContentsAPIHandler):
    ...
    async def _copy(self, copy_from, copy_to=None):
        ...
        """by teleparadigm"""
        raise web.HTTPError(400, f"Disabled copy from  {copy_from} to {copy_to}")
        self.log.info(
    ...
    async def _upload(self, model, path):
        ...
        """by teleparadigm"""
        raise web.HTTPError(400, f"Disabled upload to {path!r}")
    ...
    async def _new_untitled(self, path, type="", ext=""):
        ...
        """by teleparadigm"""
        raise web.HTTPError(400, f"Disabled creating new untitled")
    ...
    async def post(self, path=""):
        ...
        """
        """by teleparadigm"""
        raise web.HTTPError(400, f"Disabled creating new file")
    ...
    async def delete(self, path=""):
        ...
        """by teleparadigm"""
        raise web.HTTPError(400, f"{self}")
        cm = self.contents_manager
