...
class StatusHandler(BaseApiHandler):
    ...
    @check_xsrf
    def get(self):
        self.write({"status": True,"debug":True})
...
class GradeHandler(BaseApiHandler):
    ...
    def put(self, grade_id):
        self.write({"status": "disabled grade assignement"})
        '''try:
            grade = self.gradebook.find_grade_by_id(grade_id)
        except MissingEntry:
            raise web.HTTPError(404)
...
class CommentHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def put(self, grade_id):
        self.write({"status": "disabled comment assignement"})
        '''try:
            comment = self.gradebook.find_comment_by_id(grade_id)
        except MissingEntry:
            raise web.HTTPError(404)
...
class AssignmentHandler(BaseApiHandler):
    ...
    def put(self, assignment_id):
        self.write({"status": "disabled create assignement"})
        '''data = self.get_json_body()
...
class StudentHandler(BaseApiHandler):
    ...
    def put(self, student_id):
        self.write({"status": "disabled student handler"})
        '''data = self.get_json_body()
        student = {
...
class AssignHandler(BaseApiHandler):
    ...
    def post(self, assignment_id):
        self.write({"status": "disabled generate assignement"})
...
class UnReleaseHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def post(self, assignment_id):
        self.write({"status": "disabled unrelease assignement"})
...
class ReleaseHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def post(self, assignment_id):
        self.write({"status": "disabled release assignement"})
...
class CollectHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def post(self, assignment_id):
        self.write({"status": "disabled collect assignement"})
...
class AutogradeHandler(BaseApiHandler):
    ...
    def post(self, assignment_id, student_id):
        self.write({"status": "disabled autograde assignement"})
...
class GenerateAllFeedbackHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def post(self, assignment_id):
        self.write({"status": "disabled generate feedback assignement"})
...
class ReleaseAllFeedbackHandler(BaseApiHandler):
    ...
    @check_notebook_dir
    def post(self, assignment_id):
        self.write({"status": "disabled release feedback assignement"})
...
class TeleHandler(BaseApiHandler):
    @web.authenticated
    @check_xsrf
    def get(self):
        self.write({"permission denied": True})

default_handlers = [
    (r"/formgrader/api/status", TeleHandler),
